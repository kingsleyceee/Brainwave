      ...
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="absolute top-0 left-0 w-full h-full object-cover md:w-3/5 xl:w-auto">
              <img
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p>
                Brainwave unlocks the potential of AI-powered app applications
              </p>
              <ul className="body-2">
